...
/*Scenario 3: No true difference in case-mix, hospital effects vary, hospital size is uniform*/
%let scenario=3;
%let n_hosp=111;
...
/*data set that contains hospital number 1 through n
(however many hospitals that year) */
data hospitals;
do pseudo_hospital=1 to &n_hosp.;
output;end;
