/*Scenario 5: No true difference in case-mix, hospital effects.
Pseudo-hospital size matched true hospital case volume.*/
%let scenario=5;
%let n_hosp=111;
...
proc sort data=hospitals; by hospital_size; run;
