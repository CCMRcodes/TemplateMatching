/*Scenario 4B: True difference in hospital effects, no difference in hospital volume. Case mix varies by predicted mortality*/
%let scenario=4B;
%let n_hosp=111;
%let ave_hosp_size=4146; /*(460213/111)*/
%let sampsizey=91213; /*(4146*22)*/
%let sampsizeo=91213; /*(4146*22)*/
...
select distinct(anon_hospital_id) as pseudo_hospital
from simulations ;
quit;
