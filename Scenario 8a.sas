/*Scenario 8A: True difference in hospital effects, no difference in hospital volume. Case mix varies by age*/
%let scenario=8A;
%let n_hosp=111;
...
proc sort data=simulations; by quartile_age; run;/*n=460213*/
